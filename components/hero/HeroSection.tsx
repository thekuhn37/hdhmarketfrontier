...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-white">
      ...
      {/* Content */}
      <div className="relative z-10 content-width text-center py-32">
        {/* Category pill */}
        <motion.div
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <motion.div
            ...
            className="absolute top-[18%] left-[6%] hidden lg:block animate-float"
          >
            <div
          ...
          <motion.div
            ...
            className="absolute top-[22%] right-[6%] hidden lg:block animate-float-delayed"
          >
            <div
              className="px-5 py-4 rounded-2xl"
              style={{
          ...
          <motion.div
            ...
            className="absolute bottom-[22%] left-[5%] hidden lg:block animate-float-slow"
          >
            <div
              className="px-5 py-4 rounded-2xl"
              style={{
